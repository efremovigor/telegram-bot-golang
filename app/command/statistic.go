...
func GetTop10(body telegram.WebhookMessage, listener telegram.TelegramListener) {
	text := ""
	...
	listener.Msg <- telegram.GetTelegramRequest(body.GetChatId(), text)
}

func GetTop10ForUser(body telegram.WebhookMessage, listener telegram.TelegramListener) {
	text := ""
