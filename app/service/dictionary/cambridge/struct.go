...
const xpathUK = xpathBLockDescriptionEnRu + "//span[contains(@class, 'uk')]//amp-audio//audio/source[contains(@type,'audio/mpeg')]"
const xpathUS = xpathBLockDescriptionEnRu + "//span[contains(@class, 'us')]//amp-audio//audio/source[contains(@type,'audio/mpeg')]"
